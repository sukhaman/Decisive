...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    fileprivate func composeLandingScreen(_ windowScene: UIWindowScene) {
        self.window = UIWindow(windowScene: windowScene)
        let viewController = LoginUIComposer.createLoginModule(LoginViewModel(service: LoginAPIService()))
